...
def scaled_dot_product_attention(q, k, v, mask,adjoin_matrix):  #  比例点积注意力 返回 “输出，注意力权重”
...
def point_wise_feed_forward_network(d_model, dff):  #  点式前馈神经网络
...
class PredictModel(tf.keras.Model):
    def __init__(self,num_layers = 6,d_model = 256,dff = 512,num_heads = 8,vocab_size =18,dropout_rate = 0.1,dense_dropout=0.1):
